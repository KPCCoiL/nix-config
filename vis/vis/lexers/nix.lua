...
-- Copyright 2024-2025 Samuel Marquis. See LICENSE_nix_lua.
-- Nix LPeg lexer, taken from https://github.com/orbitalquark/scintillua/blob/96e32c4bdab8109393aec9ffc46b9ab61b77bd3b/lexers/nix.lua
-- Meant to be a temporary solution until the next vis release (which would include this)
